...
using isc.bempleo.be.infrastructure.Repositories.ApplicationStatus;
using isc.bempleo.be.infrastructure.Repositories.Careers;
...
using isc.bempleo.be.infrastructure.Repositories.Vacancies;
    ...
    public static class DependecyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IS3NimioRepository, S3NimioRepository>();
                ...
                services.AddScoped<IApplicationStatuRepository, ApplicationStatuRepository>();

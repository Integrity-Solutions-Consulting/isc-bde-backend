...
namespace isc.bempleo.be.api.Controllers.v1.ProfileVacancies
{
    ...
    public class ProfileVacancyController : Controller
    {
        ...
        public async Task<ActionResult<SuccessResponse<List<ProfileVacancyResponse>>>> GetAllAsync([FromQuery] bool isActive)
        {
        ...
        public async Task<ActionResult<SuccessResponse<ProfileVacancyResponse>>> CreateAsync([FromBody] ProfileVacancyRequest request)
        {
